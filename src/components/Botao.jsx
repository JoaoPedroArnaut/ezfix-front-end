...
const Botao = ({ estilo, icone, text, onClick, type }) => {
    ...
    const botao = [
        ...
        <button  type={type} onClick={onClick} className="bg-blue-dark w-32 min-w-min p-2 rounded-md text-white hover:bg-blue-light duration-75" onClick={onClick}>{text}</button>
    ]
