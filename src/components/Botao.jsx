...
const Botao = ({ estilo, icone, text, onClick, type }) => {
    ...
    const botao = [
        <button type={type} className="bg-blue w-full xl:w-60 xl:h-14 lg:w-56 lg:h-12 xl:text-lg sm:w-48 font-medium min-w-min p-2 sm:rounded-md hover:text-blue hover:bg-blue-light duration-75">{text}</button>,

        //Botão usado no componente Order
            <button type={type} onClick={onClick} className="rounded-3xl px-6 py-2  bg-blue w-52 text-white text-xl flex justify-around items-center hover:text-blue hover:bg-blue-light duration-75">
        ...
        <button type={type} className="rounded-3xl px-5 py-2 bg-blue-dark w-40 hover:text-black hover:bg-blue duration-75 text-white text-2xl font-bold flex justify-around items-center" onClick={onClick}>
            <FontAwesomeIcon icon={icone} />{text}</button>,
        ...
        <button  type={type} onClick={onClick}  className="bg-blue-dark py-3 px-5 rounded-3xl text-white">{text}</button>,
        ...
        <button className="rounded-xl px-6 py-3 bg-blue-dark w-40 hover:text-black hover:bg-blue duration-75 text-white text-xl font-semibold flex justify-around items-center" onClick={onClick}>
            <FontAwesomeIcon icon={icone} />{text}</button>,
    ]
