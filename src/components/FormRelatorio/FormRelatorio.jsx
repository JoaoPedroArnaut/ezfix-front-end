...
import { Section, WhiteArea, DivAddNew, VerticalLine } from "./styles";
  ...
  return (
    <Section>
      ...
      <div className="bg-blue-light w-full sm:w-96 p-8 sm:rounded-2xl min-h-full ">
        ...
        <DivAddNew>
          <a href=" http://localhost:3000/RelatorioProblemaAdd">
            <svg
              width="78"
              height="78"
              viewBox="0 0 78 78"
            ...
            >
              <path
                d="M39 26.5V39V26.5ZM39 39V51.5V39ZM39 39H51.5H39ZM39 39H26.5H39ZM76.5 39C76.5 59.7108 59.7108 76.5 39 76.5C18.2893 76.5 1.5 59.7108 1.5 39C1.5 18.2893 18.2893 1.5 39 1.5C59.7108 1.5 76.5 18.2893 76.5 39Z"
                stroke="#4A5568"
                stroke-width="2"
