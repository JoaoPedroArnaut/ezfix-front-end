...
const MenuOpcoes = () => {
    ...
    return (
        <>
            <div className="bg-blue-dark_light w-12 h-52 z-10 top-24 left-3/4 right-20 bottom-0 absolute p-3 rounded-b-2xl">
                            <div className="text-white font-bold leading-10">
                                <ul>
                                    <li onClick={() => {router.push("/assistencias")}}>inicio</li>
