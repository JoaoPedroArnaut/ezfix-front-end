...
const CardRelatorio = ({ produto, marca, modelo, descricao, key, id }) => {
    ...
    return (
        <>
            <div key={key} className="flex flex-col items-start bg-white mt-10 p-5 rounded-xl">
                <p className="text-xl font-semibold">{produto}</p>
                <p className="font-medium text-base mt-2">{marca} {modelo}</p>
