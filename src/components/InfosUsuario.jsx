...
const InfosUsuario = ({setNovoEndereco}) => {
    ...
    function handlelUplod(e) {
        ...
        api.post(`http://52.67.126.2:8080/solicitante/perfil/${user.cpf}`,formdata)
        .then(res => {
            router.reload();
        },err => {
            ...
            <div className="w-full flex justify-around">
                <div className="sm:w-4/5 mt-8 mb-20 p-10 border-2 border-solid border-opacity-10 border-black filter shadow-xl rounded-xl">
                    <div className="flex mb-10">
                        <img src={`http://52.67.126.2:8080/solicitante/perfil/${user.cpf}`} alt="img" width="160px" className="rounded-full" />
