...
const Section5 = () => {
    return (
        <>
            ...
            <div className="overflow-hidden lg:row-start-2 lg:row-span-2 lg:col-start-1 lg:col-span-2 sm:row-start-2 sm:row-span-3 sm:col-start-2 sm:col-span-2 row-start-1 row-span-3 col-start-1 col-span-3">
